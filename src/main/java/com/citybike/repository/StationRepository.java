...
public interface StationRepository extends CrudRepository<StationDTO, Integer> {
    ...
    List<StationDTO> findTop5ReturnStationsByStationId(@Param("stationId") int stationId);
